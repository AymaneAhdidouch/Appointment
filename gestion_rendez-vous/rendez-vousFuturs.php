...
<body>
    ...
    <div class="container mt-2">
        ...
        <table class="table table-light table-bordered shadow mt-3 text-center">
            <thead>
                <tr class="table-dark">
                ...
                <?php 
                    ...
                    if( isset($_SESSION['idMedecin']) ) {
                        ...
                        $req = "SELECT * FROM rdv INNER JOIN medecin ON rdv.id_medecin = medecin.id_mc 
                                INNER JOIN patient ON rdv.num_patient = patient.num WHERE id_mc = '$idMedecin' AND date_rdv > '$date' ORDER BY date_rdv, hour_debut";
